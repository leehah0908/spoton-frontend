                        ...
                        >
                            ...
                            <Box display='flex' flexDirection='row' sx={{ p: 1, height: '100px' }}>
                                <Box sx={{ minWidth: '40%', pt: 1 }}>
                                    <img
                                        src={`${process.env.REACT_APP_STATIC_IMAGE_URL}/leagueLogo/${value.league}/${encodeURIComponent(value.awayTeam)}.png`}
                                        alt={value.awayTeam}
                                        width='50'
                                        height='50'
                                    />
                                ...
                                <Box sx={{ minWidth: '40%', pt: 1 }}>
                                    <img
                                        src={`${process.env.REACT_APP_STATIC_IMAGE_URL}/leagueLogo/${value.league}/${encodeURIComponent(value.homeTeam)}.png`}
                                        alt={value.homeTeam}
                                        width='50'
                                        height='50'
                                    />
                                ...
                                lastestNanum.map((nanum) => (
                                    ...
                                    >
                                        <Box alignContent='center'>
                                            <img
                                                src={`${process.env.REACT_APP_NANUM_IMAGE_URL}/${encodeURIComponent(nanum.imagePath[0])}`}
                                                style={{
                                                    width: 80,
                                                    height: 80,
                                                    objectFit: 'cover',
