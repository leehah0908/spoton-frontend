                        ...
                        >
                            ...
                            <Box display='flex' flexDirection='row' sx={{ p: 1, height: '100px' }}>
                                <Box sx={{ minWidth: '40%', pt: 1 }}>
                                    <img
                                        src={`${process.env.REACT_APP_STATIC_IMAGE_URL}/leagueLogo/${value.league}/${value.awayTeam}.png`}
                                        alt={value.awayTeam}
                                        width='50'
                                        height='50'
                                    />
                                ...
                                <Box sx={{ minWidth: '40%', pt: 1 }}>
                                    <img
                                        src={`${process.env.REACT_APP_STATIC_IMAGE_URL}/leagueLogo/${value.league}/${value.homeTeam}.png`}
                                        alt={value.homeTeam}
                                        width='50'
                                        height='50'
                                    />
